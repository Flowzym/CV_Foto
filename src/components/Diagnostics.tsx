  ...
  return (
    <div className="bg-white rounded-lg border p-4 space-y-3"
      ...
      <div className="text-sm text-gray-600 space-y-1">
        ...
        <div>Files: <span className="font-mono">{ortInfo.filesPresent.length}/6</span></div>
        <div>Cross-origin: <span className="font-mono">{crossOriginIsolated ? 'Yes' : 'No'}</span></div>
      </div>
